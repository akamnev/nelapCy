...
MOD_NAMES = [
    "nelapcy.symbols",
    "nelapcy.algo.string",
    "nelapcy.algo.tokenizer",
    "nelapcy.container.doc",
    "nelapcy.container.token",
    "nelapcy.pipeline.crf",
    "nelapcy.pipeline.rules"
]
...
if os.environ.get("USE_OPENMP", USE_OPENMP_DEFAULT) == "1":
    if sys.platform == "darwin":
        ...
        PACKAGE_DATA["nelapcy.platform.darwin.lib"] = ["*.dylib"]
        PACKAGES.append("nelapcy.platform.darwin.lib")
...
def setup_package():
    ...
    with chdir(root):
        with io.open(os.path.join(root, "nelapcy", "about.py"), encoding="utf8") as f:
            about = {}
            exec(f.read(), about)
